...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'justify-center items-center w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'justify-center items-center w-full']); ?>
                <?php echo e(__('Войти')); ?>
...
<?php endif; ?>
    ...
    <div>
        ...
        <a href="<?php echo e(route('auth.github')); ?>" class="w-full inline-flex justify-center items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
            Войти через GitHub
        </a>
    </div>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/boardy/resources/views/auth/login.blade.php ENDPATH**/ ?>